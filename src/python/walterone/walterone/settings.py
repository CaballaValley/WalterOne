"""
Django settings for walterone project.
...
SECRET_KEY = getenv("SECRET_KEY", "fooABCDEF")
...
#     "localhost 127.0.0.1 [::1] 0.0.0.0").split(" ")
ALLOWED_HOSTS = ["*"]
...
WSGI_APPLICATION = 'walterone.wsgi.application'
...
MOVE_DELAY = getenv("MOVE_DELAY", 2)
ATTACK_DELAY = getenv("ATTACK_DELAY", 1)


LUCKY_UNLUCKY_DEFAULT = getenv("LUCKY_UNLUCKY_DEFAULT", 2)
GO_RYU_DEFAULT = getenv("GO_RYU_DEFAULT", 1)
LIFE_DEFAULT = getenv("LIFE_DEFAULT", 200)
